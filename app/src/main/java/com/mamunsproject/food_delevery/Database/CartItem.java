...
public class CartItem {
    ...
    public int getFoodQuantitiy() {
        return foodQuantitiy;
    }

    public void setFoodQuantitiy(int foodQuantitiy) {
        this.foodQuantitiy = foodQuantitiy;
    }
