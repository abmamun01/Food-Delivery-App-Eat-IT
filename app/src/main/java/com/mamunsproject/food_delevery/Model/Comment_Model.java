package com.mamunsproject.food_delevery.Model;
...
public class Comment_Model {
    ...
    public Comment_Model(float ratingValue, String comment, String name, String uid, Map<String, Object> commentTimeStamp) {
